...
**Audience:** someone who has finished Stage 6 Helm / Kustomize and wants to
...
- The Stage 6 tenant workloads and shared observability stack syncing into the cluster
...
$EDITOR stages/stage6/helm/apollo11/values-dev.yaml
# ... change image.tag from `latest` to `dev-2025-06-11` ...

# 6.2.2 Commit + push
git add stages/stage6/helm/apollo11/values-dev.yaml
...
> `stages/stage6/scripts/apply.sh` *before* registering the Application,
...
> (`stages/stage6/scripts/teardown.sh`) and let ArgoCD create them
